...
\bigskip
    ...
    \end{tabularx}
      ...
      The sampling theorem states if a signal contains no frequencies higher than B hertz, it is completely determined by giving its ordinates at a series of points spaced 1/(2B) seconds apart. A sufficient sample rate is therefore 2B samples/second.
      In this project the continous-time component is represented by the balance wheel (3 Hz) and the discrete-time component is represented by the frame rate and its time stamps of the camera (90 Hz) which satisfies the condition.  
