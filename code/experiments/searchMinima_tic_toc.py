...
for value in range(len(durations_of_period_in_microsec)):
    durations_of_period_in_microsec[value] = abs(durations_of_period_in_microsec[value]-166666)

durations_of_period_in_microsec.sort()

print("smallest aberration found during calculation: ", durations_of_period_in_microsec[0])
