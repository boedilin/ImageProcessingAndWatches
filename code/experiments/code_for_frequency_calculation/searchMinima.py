...
"""
directory = "../different_position_records/down/4hours/"
xValues = np.loadtxt(directory+"xValues_plus_iframe.txt")
timestamps = np.loadtxt(directory+"timestamps_plus_iframe.txt")
indexes_of_minimas_file = open(directory+"indexes_of_minimas_file_plus_iframe.txt", "a")
step_size_while_searching_file = open(directory+"step_sizes_file_plus_iframe.txt", "a")
...
print("start timestamp: ", start_timestamp, " at index: ", start_index)
print("end timestamp: ", end_timestamp, " at index: ", minima , " of ", len(timestamps))
